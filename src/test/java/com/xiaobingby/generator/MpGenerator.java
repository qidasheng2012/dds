package com.xiaobingby.generator;
...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setPassword("");
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/bing-upms?characterEncoding=utf8");
        ...
        //strategy.setInclude(new String[] { "oss_courseware" }); // 需要生成的表
        ...
        pc.setParent("com.xiaobingby.sys");
