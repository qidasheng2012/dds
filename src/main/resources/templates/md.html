...
<body>
<div id="wmd-panel-preview" class="wmd-panel-preview preview-container" style="height: 100%;">
    <div id="wmd-preview" class="wmd-preview" data-medium-element="true" style="height: auto; left: 0px;"><div class="md-section-divider"></div><div class="md-section-divider"></div><h1 data-anchor-id="l34n" id="简介">简介</h1><blockquote data-anchor-id="9dbf" class="white-blockquote">
        <p>Bing-UPMS是一个轻量级的Spring Boot快速开发平台，学习简单、轻量级、易扩展；使用最新技术。</p>
    </blockquote><div class="md-section-divider"></div><h3 data-anchor-id="59d2" id="具有如下特点"><strong>具有如下特点</strong></h3><ul data-anchor-id="od05">
        <li>友好的代码结构及注释，便于阅读及二次开发</li>
        <li>使用轻量级FreeMarker模板引擎，代替JSP</li>
        <li>灵活的权限控制，可控制到页面或按钮，满足绝大部分的权限需求</li>
        <li>Bootstrap Table进行数据展示,快速完成前端数据展示</li>
        <li>MP代码生成器模块,快速生成 entity、Mapper.xml、dao、service、controller 代码</li>
        <li>引入云存储服务，已支持：腾讯云COS对象存储</li>
        <li>通用CRUD操作,单表操作无需写任何SQL语句。把精力关注在多表操作，提高开发效率。(Mybatis-Plus)</li>
    </ul><div class="md-section-divider"></div><h3 data-anchor-id="7vr7" id="技术选型">技术选型</h3><div class="md-section-divider"></div><h4 data-anchor-id="yo1t" id="后端技术">后端技术:</h4><table data-anchor-id="vael" class="table table-striped-white table-bordered">
        <thead>
        <tr>
            <th>技术</th>
            <th>名称</th>
        ...
        <tbody><tr>
            <td>Spring Boot</td>
            <td>Spring Boot</td>
            <td><a href="http://projects.spring.io/spring-boot/" target="_blank">http://projects.spring.io/spring-boot/</a></td>
        </tr>
        <tr>
            <td>Spring MVC</td>
            <td>MVC框架</td>
        ...
        <tr>
            <td>Apache Shiro</td>
            <td>安全框架</td>
            <td><a href="http://shiro.apache.org/" target="_blank">http://shiro.apache.org/</a></td>
        </tr>
        <tr>
            <td>FreeMarker</td>
            <td>模板引擎</td>
            <td><a href="http://freemarker.org/" target="_blank">http://freemarker.org/</a></td>
        </tr>
        <tr>
            <td>MyBatis</td>
            <td>ORM框架</td>
            <td><a href="http://www.mybatis.org/mybatis-3/" target="_blank">http://www.mybatis.org/mybatis-3/</a></td>
        </tr>
        <tr>
            <td>Mybatis-Plus</td>
            <td>Mybatis 的增强工具</td>
            <td><a href="https://gitee.com/baomidou/mybatis-plus/" target="_blank">https://gitee.com/baomidou/mybatis-plus/</a></td>
        </tr>
        <tr>
            <td>Druid</td>
            <td>数据库连接池</td>
            <td><a href="http://druid.io/" target="_blank">http://druid.io/</a></td>
        </tr>
        <tr>
            <td>MySql</td>
            <td>数据库</td>
        ...
        <tr>
            <td>COS</td>
            <td>腾讯云对象存储</td>
            <td><a href="https://cloud.tencent.com/product/cos/" target="_blank">https://cloud.tencent.com/product/cos/</a></td>
        </tr>
        <tr>
            <td>Maven</td>
            <td>项目构建管理</td>
        ...
        <tr>
            ...
            <td>热部署</td>
            <td><a href="https://spring.io/blog/2015/06/17/devtools-in-spring-boot-1-3/" target="_blank">https://spring.io/blog/2015/06/17/devtools-in-spring-boot-1-3/</a></td>
        </tr>
        <tr>
            <td>JMail</td>
            <td>邮件操作组件</td>
        ...
        <tr>
            <td>Ehcache</td>
            <td>Java的进程内缓存框架</td>
            <td><a href="http://www.ehcache.org/" target="_blank">http://www.ehcache.org/</a></td>
        </tr>
        <tr>
            <td>Redis</td>
            <td>缓存数据库</td>
        ...
        </tbody></table><div class="md-section-divider"></div><h4 data-anchor-id="yd5r" id="前端技术">前端技术:</h4><table data-anchor-id="3cqb" class="table table-striped-white table-bordered">
        <thead>
        <tr>
            <th>技术</th>
            <th>名称</th>
        ...
        <tr>
            ...
            <td>文件上传插件</td>
            <td><a href="http://plugins.krajee.com/file-input/demo" target="_blank">http://plugins.krajee.com/file-input/demo</a></td>
        </tr>
        <tr>
            <td>zTree</td>
            <td>树插件</td>
            <td><a href="http://www.treejs.cn/v3/" target="_blank">http://www.treejs.cn/v3/</a></td>
        </tr>
        <tr>
            <td>Font-awesome</td>
            <td>字体图标</td>
        ...
        <tr>
            <td>H+</td>
            <td>后台管理模板</td>
            <td><a href="http://www.zi-han.net/theme/hplus/" target="_blank">http://www.zi-han.net/theme/hplus/</a></td>
        </tr>
        <tr>
            <td>wangEditor</td>
            <td>轻量级web富文本编辑器</td>
    ...
    <div class="remark-icons"><div class="remark-icon unselectable remark-icon-empty" style="top: 45px; left: 644px; display: none;" data-anchor-id="l34n">
    <span class="icon-stack">
        <i class="glyph-comment"></i>
        <span class="remark-count">+</span>
    </span>
    </div><div class="remark-icon unselectable remark-icon-empty" style="top: 105px; left: 644px; display: none;" data-anchor-id="9dbf">
    <span class="icon-stack">
        <i class="glyph-comment"></i>
        <span class="remark-count">+</span>
    </span>
    </div><div class="remark-icon unselectable remark-icon-empty" style="top: 195px; left: 644px; display: none;" data-anchor-id="59d2">
    <span class="icon-stack">
        <i class="glyph-comment"></i>
        <span class="remark-count">+</span>
    </span>
    </div><div class="remark-icon unselectable remark-icon-empty" style="top: 255px; left: 644px; display: none;" data-anchor-id="od05">
    <span class="icon-stack">
        <i class="glyph-comment"></i>
        <span class="remark-count">+</span>
    </span>
    </div><div class="remark-icon unselectable remark-icon-empty" style="top: 518px; left: 644px; display: none;" data-anchor-id="7vr7">
    <span class="icon-stack">
        <i class="glyph-comment"></i>
        <span class="remark-count">+</span>
    </span>
    </div><div class="remark-icon unselectable remark-icon-empty" style="top: 578px; left: 644px; display: none;" data-anchor-id="yo1t">
    <span class="icon-stack">
        <i class="glyph-comment"></i>
        <span class="remark-count">+</span>
    </span>
    </div><div class="remark-icon unselectable remark-icon-empty" style="top: 608px; left: 644px; display: none;" data-anchor-id="vael">
    <span class="icon-stack">
        <i class="glyph-comment"></i>
        <span class="remark-count">+</span>
    </span>
    </div><div class="remark-icon unselectable remark-icon-empty" style="display: none;" data-anchor-id="yd5r">
    <span class="icon-stack">
        <i class="glyph-comment"></i>
        <span class="remark-count"></span>
    </span>
    </div><div class="remark-icon unselectable remark-icon-empty" style="top: 1331px; left: 644px; display: none;" data-anchor-id="3cqb">
    <span class="icon-stack">
        <i class="glyph-comment"></i>
        <span class="remark-count">+</span>
    </span>
